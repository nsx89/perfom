...
function ymCal( o, c, dir, month, year, handler, zIndex, distance ) {
	...
	var html = '<div class="ymCal ym' + dir.substring( 0, 1 ).toUpperCase() + dir.substring( 1 ) + '"><div class="msg"><table cellspacing="0" cellpadding="0" border="0">';
	html += '<tr><td colspan="2" class="mc"><div class="btn mDec"><i class="new-icomoon icon-Angle-up"></i></div></td><td class="yc"><div class="btn yDec"><i class="new-icomoon icon-Angle-up"></i></div></td></tr>';
	...
	html += '<tr><td colspan="2" class="mc"><div class="btn mInc"><i class="new-icomoon icon-Angle-down"></i></div></td><td class="yc"><div class="btn yInc"><i class="new-icomoon icon-Angle-down"></i></div></td></tr>';
	html += '</table><div class="btn ok">ОК</div><div class="btn curDate" title="текущая дата"><i class="new-icomoon icon-prof-4"></i></div><div class="btn cancel">ОТМЕНА</div></div></div>';
