     ...
     <div class="left-block">
         ...
         <div class="pc-rules">
             ...
             <div class="pc-rules-item">
                 ...
                 или отправить на E-mail.
             </div>
         </div>
     </div>
    <div class="right-block">
        <div class="top-right-block">
            <div class="pc-project-title" style="display:none;">
              <div class="pc-project-number">Проект №1718</div>
              <div class="pc-project-date">18.11.2018 <span>16:58</span></div>
            </div>
        ...
        <div class="bottom-right-block">
            <div class="pc-unusuall-wall-btn" data-type="pc-unusuall"><i class="new-icomoon icon-comment"></i>Сообщить о нетипичной стене</div><?/*  no-active*/?>
            <div class="pc-unusuall-wall-btn pc-unusuall-clear-btn" data-type="pc-clear"><i class="new-icomoon icon-garbage"></i>Очистить поля</div> <?/*  no-active*/?>
        </div>
...
<section class="pc-project">
  <div class="pc-create-new-project pc-button" style="display:none;" data-type="create-project">Создать новый проект</div>
  ...
  <? } else { ?>
    <? foreach($data_arr['calculate'] as $r=>$room) { ?>
      <div class="pc-room-item" data-type="room-item">
        ...
        <div class="pc-room-content" style="display:none;">
