...
if ($detectPoint->isMobile()) {
    ...
    require_once($_SERVER["DOCUMENT_ROOT"] . "/responsive/news-new/media/index.php");
    ...
    <link rel="stylesheet" href="<?= $server_path ?>media/media-style.css?<?= $release ?>" type="text/css"/>
    ...
    <div class="e-page-content e-pc-news">
        <div class="e-pc-left-column">
            <div class="e-pc-main-img">
                ...
                <img src="<?= $server_path . 'media/' . $item['FOLDER']['VALUE'] . '/' . $item['THUMB']['VALUE'] ?>"
                     alt="alt">
            </div>
            <?
            ...
            <div class="clear"></div>
            <? if ($item['LINK']['VALUE']): ?>
                <a href="<?= $item['LINK']['VALUE'] ?>" class="article-link" target="_blank">Открыть проект</a>
            <?endif; ?>
