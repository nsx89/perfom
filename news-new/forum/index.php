...
if ($detectPoint->isMobile()) {
    ...
    require_once($_SERVER["DOCUMENT_ROOT"] . "/responsive/news-new/forum/index.php");
    ...
    <link rel="stylesheet" href="<?= $server_path ?>forum/forum-style-1.css?<?= $release ?>" type="text/css"/>
    ...
    ?>
    <? $APPLICATION->AddChainItem("Форум", "#"); ?>
    ...
    <div class="e-page-content e-pc-news">
        ...
        <div class="e-pc-left-column">
            <div class="e-pc-main-img">
                ...
                <img src="<?= $server_path . 'forum/' . $item['FOLDER']['VALUE'] . '/' . $item['THUMB']['VALUE'] ?>"
                     alt="alt">
            </div>
            <?
