...
if ($detectPoint->isMobile()) {
    ...
    require_once($_SERVER["DOCUMENT_ROOT"] . "/responsive/news-new/exhibitions/index.php");
    ...
    <link rel="stylesheet" href="<?= $server_path ?>exhibitions/exhibitions-style.css?<?= $release ?>" type="text/css"/>
    ...
    ?>
    <? $APPLICATION->AddChainItem("Выставки", "#"); ?>
    ...
    <div class="e-page-content e-pc-news">
        ...
        <div class="e-pc-left-column">
            <div class="e-pc-main-img">
                ...
                <img src="<?= $server_path . 'exhibitions/' . $item['FOLDER']['VALUE'] . '/' . $item['THUMB']['VALUE'] ?>"
                     alt="alt">
            </div>
            <?
