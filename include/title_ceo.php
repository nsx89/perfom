...
if (empty($CITY_ID)) $CITY_ID = 3109; //Москва по умолчанию (для роботов)
/* --- // --- */
...
if ($city_item) {
    ...
    $PROP_NAME = $city_info['name_d']['VALUE'];
    if (!empty($PROP_NAME)) $CITY_NAME = $PROP_NAME;
    // echo $CITY_NAME;
    //echo '<pre>';print_r($city_info);echo '</pre>';

    $CITY_NAME_3 = $CITY_NAME;
    if ($city_info['ID'] == '3196') $CITY_NAME_3 = 'СПБ';
}
...
/*if(isset($last_section) && !isset($is_product)) {
