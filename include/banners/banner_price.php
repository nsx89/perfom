...
<div class="bnr-wrap">
    ...
    <div class="bnr-mess" style="margin-bottom: 25px;">Уважаемые посетители сайта,</div>
    <div class="bnr-mess" style="margin-bottom: 15px;">14 февраля состоится повышение цен на продукцию ТМ&nbsp;Европласт</div>
</div>
